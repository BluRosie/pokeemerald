                                                                        ...
                                                                        | BATTLE_TYPE_TRAINER_HILL)))
    {
        ...
        for (i = 0; i < monsCount; i++)
        {
            ...
            case 0:
            {
                ...
                if (partyData[i].superShiny)
                {
                    // if a super shiny, generate a random ot id that makes the mon super shiny
                    u32 otId;
                    do {
                        otId = Random();
                    } while (GET_SHINY_VALUE(otId, personalityValue) >= SUPER_SHINY_ODDS);
